...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: It was expected Bob, but got Sue. The queue order was reversed (LIFO instead of FIFO), 
    // which was causing errors in almost all test cases.
    ...
    // Defect(s) Found: It was expected Tim, but got Sue. The queue order was reversed (LIFO instead of FIFO), 
    // which was causing errors in almost all test cases.
